...
----------------------------------------------------------------------*/
#define PRGNAME     "Ramp-all"
#define DESCRIPTION "find frequent item sets with Ramp-all"
#define VERSION     "NUCES-FAST" \
                    "(c) 2005   Shariq Bashir"
...
#define OF_LIST     0x10        /* list supporting transactions */
...
/*----------------------------------------------------------------------
  Global Variables
----------------------------------------------------------------------*/
//unsigned int		**FrequentPair;
//unsigned int		**FrequentPairMatrix; // 0 denotes infrequent
										  // 1 denotes frequent
